...
export const articleSeeds: ArticleSeed[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { title: "Daily Use: 3–5 Grams", paragraphs: ["You do not need a loading phase and you do not need to cycle it. A consistent 3–5 grams of creatine monohydrate per day is a simple approach for most healthy adults.", "Pick a time you will remember. Daily consistency beats obsessing over a perfect clock time."], bullets: ["Choose plain creatine monohydrate", "Use 3–5 g daily", "Drink normally and eat normally", "Stop and get advice if you have an unusual reaction"], visual: { src: "/manus-storage/creatine-daily-dose-internal_483b94b5.jpg", alt: "Creatine daily dose reference" } },
  ...
  },
  {
    ...
    sections: [
      ...
      { title: "The Timing Hierarchy", paragraphs: ["Get the big picture right before you obsess over the minute on the clock. Protein timing is useful only after your daily target is close to handled."], bullets: ["Hit your total daily protein first", "Spread protein across three or four meals", "Use whey before or after training when it makes the day easier", "Use it to close a gap, not replace every meal"], visual: { src: "/manus-storage/whey-protein-target-internal_904a9c17.jpg", alt: "Daily whey protein target reference" } },
